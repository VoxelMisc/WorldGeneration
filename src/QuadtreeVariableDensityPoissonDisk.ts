// Taken from https://www.npmjs.com/package/poisson-disk-sampling

import { getNeighbourhoodMemoized } from './Neighbourhood'
const getNeighbourhood = getNeighbourhoodMemoized

var tinyNDArray = require('./TinyNdArray').array
 ...
 * @constructor
 */
export function VariableDensityPDS (options, rng, canUseFunc) {
...
VariableDensityPDS.prototype.canUseFunc = null;
